...
class PaparazziTest {
  @get:Rule
  val paparazzi = Paparazzi(environment = testEnvironment())

  private fun testEnvironment(): Environment {
    //this file is generated by the task 'generateTestConfig'
    return detectEnvironment(paparazziResourcesDetailsFile =  "build/intermediates/paparazzi/resources.txt")
  }
