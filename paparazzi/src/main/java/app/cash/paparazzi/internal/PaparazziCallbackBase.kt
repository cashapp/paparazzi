...
internal abstract class PaparazziCallbackBase(
    ...
    fun initResources() {
        val rClass = loadRClass("$packageName.R")
    ...
    protected abstract fun loadRClass(className: String): Class<*>
    ...
    override fun getOrGenerateResourceId(resource: ResourceReference): Int = resources[resource]
            ?: 0
